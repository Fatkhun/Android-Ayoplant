...
/**
 * This is a sample GoogleOAuthActivity that has been extracted from {@link com.firebase.client.AuthData} to
    ...
    private void resolveSignInError() {
        if (mGoogleConnectionResult.hasResolution()) {
            try {
                ...
                mGoogleConnectionResult.startResolutionForResult(this, SignInFragment.RC_GOOGLE_LOGIN);
    ...
    private void getGoogleOAuthTokenAndLogin() {
        ...
        AsyncTask<Void, Void, String> task = new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... params) {
                ...
                try {
                    ...
                    if (!mGoogleIntentInProgress) {
                        ...
                        startActivityForResult(recover, SignInFragment.RC_GOOGLE_LOGIN);
                    }
            ...
            protected void onPostExecute(String token) {
                ...
                setResult(SignInFragment.RC_GOOGLE_LOGIN, resultIntent);
                finish();
            }
        };
        task.execute();
